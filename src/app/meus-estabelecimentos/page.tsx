...
const S = {
  ...
  body: { display:'flex', minHeight:'500px', flexWrap:'wrap' as const } as React.CSSProperties,
  lista: { width:'260px', minWidth:'180px', maxWidth:'100%', borderRight:'2px solid #1E3A8A', flexShrink:0 } as React.CSSProperties,
  ...
  painel: { flex:1, minWidth:'280px', padding:'20px', backgroundColor:'#F8FAFC' } as React.CSSProperties,
