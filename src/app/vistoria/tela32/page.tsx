    ...
    async function carregar() {
      ...
      try {
        ...
        if (cpfInspetor) {
          ...
          try {
            const rCC = await fetch(`/api/contato-cliente?cpf_inspetor=${cpfInspetor}&cnpjoucpf=${cnpjoucpf}&tipo_servico=${encodeURIComponent('32 Vistoria inspeção')}`)
        ...
        fetch('/api/criticidade-gut?tipo_servico=32%20Vistoria%20inspeç%C3%A3o')
          .then(r => r.json())
          .then(d => {
