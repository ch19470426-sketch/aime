...
const S: Record<string, React.CSSProperties> = {
  ...
  photoArea:     { border: '1.5px dashed #c3d4f0', borderRadius: '5px', background: '#E8EEF7', minHeight: '320px', position: 'relative', overflow: 'hidden', cursor: 'pointer', margin: '0 -14px' },
