    ...
    async function carregar() {
      ...
      try {
        ...
        if (cpfInspetor) {
          ...
          try {
            const rCC = await fetch(`/api/contato-cliente?cpf_inspetor=${cpfInspetor}&cnpjoucpf=${cnpjoucpf}&tipo_servico=${encodeURIComponent('34 Vistoria fachada')}`)
        ...
        fetch('/api/criticidade-gut?tipo_servico=34%20Vistoria%20fachada')
          .then(r => r.json())
          .then(d => {
