    ...
    async function carregar() {
      ...
      try {
        ...
        if (cpfInspetor) {
          ...
          try {
            const rCC = await fetch(`/api/contato-cliente?cpf_inspetor=${cpfInspetor}&cnpjoucpf=${cnpjoucpf}&tipo_servico=${encodeURIComponent('31 Autovistoria')}`)
        ...
        fetch('/api/criticidade-gut?tipo_servico=31%20Autovistoria')
          .then(r => r.json())
          .then(d => {
