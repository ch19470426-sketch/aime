...
export async function POST(request: NextRequest) {
  ...
  const descSistema = (s: string) => DESC_SISTEMAS_41[s] || `Sistema construtivo: ${s.replace(/_/g,' ').slice(3)}`
    ...
    const ITENS33 = tipoServico==='43' ? [
      ...
      {l:'a)',d:'Quanto ao ESTADO DE CONSERVAÇÃO da fachada pode ser classificado como:',v:X(cl.risco),bg:'fef9c3',fg:'854d0e'},
      {l:'b)',d:'O histórico de MANUTENÇÃO da fachada:',v:X(cl.manut),bg:'f3e8ff',fg:'6b21a8'},
      {l:'c)',d:'A AGRESSIVIDADE DO MEIO AMBIENTE sobre a fachada é considerada:',v:X(cl.desempenho),bg:'fef9c3',fg:'854d0e'},
      {l:'d)',d:'O RISCO DE QUEDA DE ELEMENTOS da fachada é considerado:',v:X(cl.uso),bg:'fee2e2',fg:'991b1b'},
