...
const C: Record<string, Record<string, string>> = {
  ...
  "12": {
    ...
    "apresentacao": "Conforme solicitado, apresentamos a proposta técnica e comercial para execução dos serviços de **Inspeção Predial,** conforme a ABNT NBR 16.747/2020, normas correlatas e Norma de Inspeção Predial do IBAPE/2025.",
    "frase_servico": "O serviço de inspeção será executado para o(a) <nome do\ncondomínio/nome>, localizado no <endereço (logradouro,\nnúmero/complemento, bairro, município/uf)>.",
  ...
  "13": {
    ...
    "apresentacao": "Conforme solicitado, apresentamos a proposta técnica e comercial para execução do serviço de **Vistoria em Imóvel Novo,** seguindo as recomendações da ABNT/NBR 15.575 e normas correlatas, Norma de Inspeção Predial do IBAPE/2025.",
    "frase_servico": "O serviço de inspeção será executado para o(a) <nome do\ncondomínio/nome>, localizado no <endereço (logradouro,\nnúmero/complemento, bairro, município/uf)>.",
  ...
  "14": {
    ...
    "apresentacao": "Conforme solicitação, apresentamos a proposta técnica e comercial para execução do serviço de **Inspeção de Fachadas,** seguindo as recomendações NBR 13.755, NBR 13.749, NBR 16.747, normas complementares e a Norma de Inspeção Predial do IBAPE/2025.",
    "frase_servico": "O serviço de inspeção será executado para o(a) <nome do\ncondomínio/nome>, localizado no <endereço (logradouro,\nnúmero/complemento, bairro, município/uf)>.",
  ...
  "15": {
    ...
    "apresentacao": "Conforme solicitado, apresentamos a proposta técnica e comercial para execução dos serviços de **Inspeção Inteligente em Elevadores,** conforme a ABNT NBR 16.858, metodologia da NBR 16.747 ajustada e normas correlatas.",
    "frase_servico": "O serviço de inspeção será executado para o(a) <nome do\ncondomínio/nome>, localizado no <endereço (logradouro,\nnúmero/complemento, bairro, município/uf)>.",
  ...
  "16": {
    "ao": "Para",
    "ref": "Ref.: Proposta comercial para Inspeção em Instalações Elétricas - NR-10.",
    "apresentacao": "Conforme solicitado, apresentamos a proposta técnica e comercial para execução dos serviços de **Inspeção em Instalações Elétricas,** conforme a NR-10 do Ministério do Trabalho e normas correlatas.",
    "frase_servico": "O serviço de inspeção será executado para o(a) <nome do\ncondomínio/nome>, localizado no <endereço (logradouro,\nnúmero/complemento, bairro, município/uf)>.",
    ...
    "documentacao": "Em reunião com o responsável será informado do conjunto de documentos\nnecessárias à realização do trabalho.\n\nTemos como política de privacidade o sigilo de todo o material fornecido\npelos clientes, sendo que até a apresentação desta proposta não tivemos\nacesso a qualquer tipo de informação que possa ser enquadrada como de\ncaráter reservado.\n\nFica ainda consignado que a reprodução total ou parcial do trabalho por\nqualquer forma mecânica ou eletrônica, somente poderá ser realizada com\nnossa autorização expressa, detentora dos direitos autorais.",
    "equipe": "**4.1.- Equipe de Trabalho:**\n\nA equipe será composta por engenheiro elétrico, inscritos nas entidades\nde classe, e pessoal de apoio técnico operacional, atendendo o exigido na legislação vigente.\n\n**4.2.- Produtos Entregues.**\n\nApós a conclusão dos trabalhos será entregue:\n\n-   Laudo de Inspeção com as respectivas Anotações de Responsabilidade\n    > Técnica - ART;\n\n-   Arquivos em mídia magnética contendo o Laudo de Inspeção Predial e\n    > demais documentos em anexo.",
    "honorarios": "O preço dos serviços, com base na estimativa de horas trabalhadas,\nconforme tabela do IBAPE - Instituto Brasileiro de Avaliações e\nPerícias, e válido para 30 (trinta) dias, a partir desta data, é o\nseguinte:\n\n-   O valor pela prestação do serviço é de **R\\$ <valor> (<valor por\n    extenso> reais)** sem encargos. Este valor será acrescido de 15,50%\n    referente a emissão da nota fiscal.\n\n-   Os demais impostos e taxas, inclusive encargos sociais pertinentes,\n    correrão à conta do proponente.\n\nO pagamento deverá ser efetuado mediante depósito bancário, ou outra\nforma ajustada entre os contratantes, nas seguintes condições:\n\n-   50% (cinquenta por cento) na data de realização da reunião com o\n    > responsável;\n\n-   50% (cinquenta por cento) para pagamento na entrega do Laudo de\n    > Inspeção.",
  ...
  "17": {
    "ao": "Para",
    "ref": "Ref.: Proposta comercial para Inspeção em Máquinas e Equipamentos -- NR-12.",
    "apresentacao": "Conforme solicitado, apresentamos a proposta técnica e comercial para execução dos serviços de **Inspeção em Máquinas e Equipamentos,** conforme a NR-12 do Ministério do Trabalho e normas correlatas.",
    "frase_servico": "O serviço de inspeção será executado para o(a) <nome do\ncondomínio/nome>, localizado no <endereço (logradouro,\nnúmero/complemento, bairro, município/uf)>.",
    ...
    "documentacao": "Em reunião com o responsável será informado do conjunto de documentos\nnecessárias à realização do trabalho.\n\nTemos como política de privacidade o sigilo de todo o material fornecido\npelos clientes, sendo que até a apresentação desta proposta não tivemos\nacesso a qualquer tipo de informação que possa ser enquadrada como de\ncaráter reservado.\n\nFica ainda consignado que a reprodução total ou parcial do trabalho por\nqualquer forma mecânica ou eletrônica, somente poderá ser realizada com\nnossa autorização expressa, detentora dos direitos autorais.",
    "equipe": "**4.1.- Equipe de Trabalho:**\n\nA equipe será composta por engenheiro mecânico, inscrito nas entidades\nde classe, e pessoal de apoio técnico operacional, atendendo o exigido na legislação vigente.\n\n**4.2.- Produtos Entregues.**\n\nApós a conclusão dos trabalhos será entregue:\n\n-   Laudo de Inspeção em Máquinas e Equipamentos com a respectiva\n    > Anotação de Responsabilidade Técnica -- ART;\n\n-   Arquivos em mídia magnética contendo o Laudo e demais documentos em\n    > anexo.",
    "honorarios": "O preço dos serviços, com base na estimativa de horas trabalhadas,\nconforme tabela do IBAPE -- Instituto Brasileiro de Avaliações e\nPerícias, e válido para 30 (trinta) dias, a partir desta data, é o\nseguinte:\n\n-   O valor pela prestação do serviço é de **R\\$ <valor> (<valor por\n    extenso> reais)** sem encargos. Este valor será acrescido de 15,50%\n    referente a emissão da nota fiscal.\n\n-   Os demais impostos e taxas, inclusive encargos sociais pertinentes,\n    correrão à conta do proponente.\n\nO pagamento deverá ser efetuado mediante depósito bancário, ou outra\nforma ajustada entre os contratantes, nas seguintes condições:\n\n-   50% (cinquenta por cento) na data de realização da reunião com o\n    > responsável;\n\n-   50% (cinquenta por cento) para pagamento na entrega do Laudo de\n    > Inspeção.",
    "prazos": "O Laudo será entregue no prazo máximo de até 10 (dez) dias úteis,\ncontados a partir da data de recebimento da documentação solicitada em\nreunião com o responsável.\n\nTambém deverá haver comprometimento mútuo para execução dos trabalhos\nsegundo agenda de trabalho, a ser definida de comum acordo entre o\nInspetor e o responsável na reunião inicial.",
    "rescisao": "Caso haja supressão total ou parcial do trabalho por interesse do\ncontratante, o contratado fará jus ao valor respectivo dos honorários\nainda devidos, não havendo obrigatoriedade de qualquer tipo de reembolso\nda parcela já recebida.\n\nAlém disso, fica consignado que eventuais alterações do trabalho somente\nserão efetuadas até 30 (trinta) dias após a entrega do laudo, sem custo\nadicional."
  },
  "18": {
    "ao": "Para",
    "ref": "Ref.: Proposta comercial para Inspeção em Caldeiras, Vasos de Pressão, Tubulações e Tanques -- NR-13.",
    "apresentacao": "Conforme solicitado, apresentamos a proposta técnica e comercial para execução dos serviços, conforme a NR-13 do Ministério do Trabalho e normas correlatas.",
    "frase_servico": "O serviço de inspeção será executado para o(a) <nome do\ncondomínio/nome>, localizado no <endereço (logradouro,\nnúmero/complemento, bairro, município/uf)>.",
...
export async function POST(request: NextRequest) {
  ...
  const cp = {
    ...
    const rodIns = (insp.rodape_documentos || `${insp.nome_inspetor || ''} — ${insp.titulo_profissional || ''} — CREA/CAU ${insp.inscricao_crea_cau || ''}`).replace(/\r?\n/g, ' ').trim()
...
@page {
  ...
  @top-center {
    content: ${JSON.stringify(insp.cabecalho_documentos || TITULO_TIPO[tipoServico] || '')};
...
<p style="text-align:justify;margin:6pt 0">O serviço será executado para o(a) <b>${tipoServico === '13' ? 'Sr(a) ' : ''}${razaoSocial}</b>, localizado na(o) <b>${endereco}</b>.</p>
...
<ul>
<li style="text-align:justify;text-align-last:left">50% (cinquenta por cento) na data de realização da reunião com o responsável;</li>
...
<p style="text-align:justify;margin:6pt 0">O laudo será entregue no prazo máximo de até <b>${prazoNum} (${prazoEx}) dias úteis</b>, contados a partir da data de recebimento da documentação solicitada em reunião com o responsável.</p>
<p style="text-align:justify;margin:6pt 0">Também deverá haver comprometimento mútuo para execução dos trabalhos segundo agenda de trabalho, a ser definida de comum acordo entre o Inspetor e o responsável na reunião inicial.</p>
