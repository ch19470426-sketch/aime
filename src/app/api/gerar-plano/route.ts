...
export async function POST(request: NextRequest) {
  try {
    ...
    partes.push('<p style="font-size:8pt;line-height:1">[Assinatura digital]</p>')
    partes.push('<p style="line-height:1"><strong>' + insp.nome_inspetor + '</strong></p>')
    partes.push('<p style="line-height:1">' + tituloLimpo(insp.titulo_profissional) + ' — ' + siglaConselho + ' ' + numLimpo(insp.inscricao_crea_cau) + '</p>')
    if (insp.especializacao) partes.push('<p style="line-height:1">Especialista ' + insp.especializacao + '</p>')
    partes.push('<p style="margin-top:48pt;line-height:1">De acordo: _____________________ CPF: _______________ Data: ___/___/______</p>')
