...
export async function POST(request: NextRequest) {
  try {
    ...
    if (ehNR) {
      ...
      partsNR.push('<div style="height:1cm;background:#fff"></div>')
      partsNR.push('</div>')
      partsNR.push('</div>')
      ...
      partsNR.push('<div class="section"><div class="titulo" style="text-align:center">Anexo 4 – Anotação de Responsabilidade Técnica</div>' +
        (complemento?.artRrt
          ? '<div style="text-align:center;margin:8mm 0"><img src="' + complemento.artRrt + '" style="width:190mm;height:260mm;object-fit:fill"/></div>'
...
<div class="bloco">
  ...
  <div class="row">
    ...
    <div class="cell"><label>Tel / WhatsApp</label><div class="val">${fmtTel(estab?.whatsapp_responsavel||estab?.whatsapp||'')}v>
