...
export function gerarCapa(p: CapaParams): string {
  ...
  // Usa position:fixed para as faixas — no WeasyPrint ancora nas bordas físicas da página
  // O corpo usa margin para não sobrepor as faixas fixas
  return `<div class="pg-capa" style="${F};counter-reset:page 0;position:relative;height:297mm;overflow:hidden">

  <!-- Faixa superior fixa no topo da página física -->
  <div style="position:absolute;top:0;left:0;right:0;height:8mm;background:#1E3A8A"></div>

  <!-- Cabeçalho logo abaixo da faixa superior -->
  <div style="position:absolute;top:8mm;left:0;right:0;text-align:center;padding:8mm 20mm 0">
    ${cabHtml}
  </div>

  <!-- Bloco central: centralizado vertical e horizontalmente -->
  ...
  <!-- Bloco profissional ancorado ao rodapé -->
  <div style="position:absolute;bottom:8mm;left:0;right:0">
    <div style="border-top:2px solid #1E3A8A;margin:0 20mm"></div>
    <div style="${F};padding:6mm 20mm;font-size:9.5pt;color:#222;line-height:1.9">
  ...
  <!-- Faixa inferior fixa no rodapé da página física -->
  <div style="position:absolute;bottom:0;left:0;right:0;height:8mm;background:#1E3A8A"></div>
